...
//-----------------------------------
    ...
    void handleNewAirportButton() throws SQLException {
        ...
        newAirport.setUserId(loggedInUser.getId());
        System.out.println("logged in user ---------------------------------------------- : " + loggedInUser.getId());
        // Set other attributes of the airport
...
// Apply the CSS styling directly
    ...
    void showStatsPage(ActionEvent event) {
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/Airport/airport_stat.fxml"));
